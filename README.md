...
## Lifecycle, input, draw, renderer, canvas, debug, file I/O, timing, and threading
...
assumptions, debug overlay assumptions, file I/O assumptions, and timing
...
`docs/file_io_contract.md`, and `docs/timing_frame_contract.md`.
